...
subtitle: "Relatório preliminar: análises sobre valores e perfil dos condenados"
...
output: 
    bookdown::html_document2:
      code_folding: hide
vignette: >
  %\VignetteIndexEntry{Analise preliminar 1}
...
```{r mapa1, warning=FALSE, message=FALSE, fig.cap = 'Volume de pessoas por Unidade Federativa.', out.width="60%", fig.align='center', eval = F}
...
```{r mapa2, warning=FALSE, message=FALSE, fig.cap = 'Pessoas por cem mil habitantes em cada Unidade Federativa.', out.width="60%", fig.align='center', eval = F}
...
```{r perc, fig.cap="Gráfico quantil-quantil do valor da multa por tipo de pessoa (escala log).", out.width="80%", fig.align='center', eval = F}
p <- tidy_cnc %>% 
