...
- `cnc_download_pessoa_infos()` para baixar as páginas de informações de pessoas do CNC.
...
- `cnc_parse_pessoa_infos()` transformas os arquivos baixados por `cnc_download_pessoa_infos()` em `tibble`.
